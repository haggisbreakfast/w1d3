...
var printTracks = function () {
  ...
  for (var i in library.tracks)
    console.log(i + ": " + library.tracks[i].name + " by " + library.tracks[i].artist + "(" + library.tracks[i].album + ")" )
}
//
printTracks()
...
var printPlaylist = function (playlistId) {
  //console.log(library.playlists[a].name + " - " + library.playlists[a].tracks.length + " tracks")
  console.log(playlistId+": "+library.playlists[playlistId].name+" - "+library.playlists[playlistId].tracks.length+" tracks");
  //display the tracks information for this playlistId
...
var addTrack = function (name, artist, album) {
    ...
    var adder = library.tracks[newaweSomeTrack.id] = newaweSomeTrack;

  console.log(library.tracks);
}
addTrack('My Good Songs', 'Rohit', 'My first Album');
